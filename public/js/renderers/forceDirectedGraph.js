define(["app/renderer", "d3", "underscore"], function (Renderer, d3, _) {
    ...
    renderer.render = function (settings) {
        ...
        _.defaults(settings, renderer.defaults);
        settings.data = settings.data || renderer.exampleData();
        ...
        for (var k in settings.edgestyle) {
            link.style(k,settings.edgestyle[k]);
        }
